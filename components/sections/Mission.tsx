                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative z-10 space-y-8">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-7xl font-bold font-sans text-white leading-tight">
                                Excel. <br />
                                Exceed. <br />
                        ...
                        <motion.p
                            ...
                            className="text-gray-400 text-lg md:text-xl font-light leading-relaxed max-w-md border-l-2 border-cyan-500/30 pl-6"
                        >
                    ...
                    <div className="relative h-[50vh] lg:h-[70vh] w-full rounded-2xl overflow-hidden border border-white/5 bg-white/5 backdrop-blur-sm shadow-2xl">
                        ...
                        <div className="absolute bottom-4 right-4 z-20 font-mono text-[10px] text-cyan-500/50">
                            FIG 2.4 - HULL_GEO
                        </div>
                    </div>
